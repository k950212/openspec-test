...
The system SHALL present a product listing view that shows catalog products with essential details for shopping, provides a path to open an individual product page, includes wishlist and cart actions, provides a quick view entry point for in-context product preview, and shows sale badges for eligible products.
